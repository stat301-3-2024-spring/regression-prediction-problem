...
regression_recipe_2 <- recipe(price ~., data = train_regression) |> 
...
regression_recipe_2_check <- prep(regression_recipe_2) |>
  bake(new_data = NULL)

save(regression_recipe_2, file = here('attempt_2/results/regression_recipe_2.rda'))