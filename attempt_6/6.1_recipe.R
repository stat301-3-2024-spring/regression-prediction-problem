...
regression_recipe_3 <- recipe(price ~., data = train_regression) |> 
...
regression_recipe_3_check <- prep(regression_recipe_3) |>
  bake(new_data = NULL)

save(regression_recipe_3, file = here('attempt_6/results/regression_recipe_3.rda'))